  ...
  return (
    <Page>
      ...
      <Text>
        ...
        features to your apps. It lets you add 1-1 and group chat to your app,
        along with typing indicators, online presence, and a flexible
        permissions system.
      </Text>
      <Heading>Example use cases</Heading>
      <Text>
        Our powerful API and SDKs allows you to build a multitude of different
        chat features quickly while being flexibile enough to suit many use
        cases, for example:
      </Text>
      <Ul>
        <Li>
          Adding social chat features in your app, whether that be 1-1 or group
          chat
        </Li>
        <Li>Player to player chat and presence in your multiplayer game</Li>
        <Li>
          Helping users work together in a collaborative app where inline
      ...
      <Text>
        In addition to core features such as creating rooms, users, and sending
        messages, the beta also includes:
      </Text>
      <Ul>
        <Li>
          Private and public rooms - You can choose to let anyone access a room,
          or make it private.
        </Li>
        <Li>
          Presence updates - Get updated when users change their online/offline
          status.
        </Li>
        <Li>
          Typing indicators - Receive events when users start or stop typing in
          rooms.
        </Li>
      </Ul>
      <Heading>Sample code</Heading>
      <Text>
        Below are a few snippets of sample Swift code to give you an idea of
        what integrating with Chatkit looks like in an iOS application. We also
        provide{' '}
        <Link href="https://github.com/pusher/chatkit-android">Android</Link>{' '}
        and{' '}
        <Link href="https://github.com/pusher/chatkit-client-js">
          JavaScript
        </Link>{' '}
        SDKs if you are building for Android or the web.
      </Text>
      ...
      <Ul>
        <Li>
          Chatkit: The Pusher service that your clients will connect to for
        ...
        <Li>
          ...
          <Link href="/chatkit/authentication">authentication tokens</Link> and
          to make admin requests to Chatkit.
        </Li>
      </Ul>
      ...
      <Text>
        There are certain limits that will be in place at least for the beta,
        detailed below:
      </Text>
      <Ul>
      ...
      <Ul>
        <Li>
          <Link href="/chatkit/core-concepts">
            Check out Chatkit’s core concepts
          </Link>
        </Li>
        <Li>
        ...
        <Li>
          <Link href="https://github.com/pusher/chatkit-android">
            Read up on the Andoid SDK
          </Link>
        </Li>
        <Li>
          <Link href="https://github.com/pusher/chatkit-client-js">
            Read up on the JS SDK
          </Link>
        </Li>
      </Ul>
    </Page>
